...
Also discarded were numeric columns with NA values and those columns containing the
record number, username, timestamps, and window information.  This left a set of 51 predictors.
